...
import com.example.binus_ezy_foody.databinding.ActivityDetailBinding;
        ...
        if (getIntent().getIntExtra("type", 0)==1) {
            ...
            binding.insertBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (isInserted)
                        Toast.makeText(com.example.binus_ezy_foody.DetailActivity.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                    else
                        Toast.makeText(com.example.binus_ezy_foody.DetailActivity.this, "error", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        final int img= cursor.getInt(4);
            ...
            binding.insertBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                  ...
                  if(isUpdated)
                      Toast.makeText(com.example.binus_ezy_foody.DetailActivity.this, "Updated", Toast.LENGTH_SHORT).show();
                  else
                      Toast.makeText(com.example.binus_ezy_foody.DetailActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                }
            });
